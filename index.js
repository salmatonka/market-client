...
async function run() {
  try {
    const mobileCategoryCollection = client.db('marketUser').collection('mobileCategory');
    const usedMobileCollection = client.db('marketUser').collection('allMobiles');
    const bookingsCollection = client.db('marketUser').collection('bookings');
    const usersCollection = client.db('marketUser').collection('users');
